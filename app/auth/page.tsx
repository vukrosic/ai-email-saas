    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-purple-400 via-pink-500 to-red-500 flex justify-center items-center p-4">
            <div className="bg-white rounded-lg shadow-2xl p-8 w-full max-w-md flex flex-col justify-between items-stretch">
                <h1 className="text-3xl font-bold text-center text-gray-800 mb-8">AI with superior interface</h1>
                ...
                <p className="text-sm text-gray-600 text-center">
                    By continuing, you agree to our <Link href="/terms-of-service" target="_blank" rel="noopener noreferrer">Terms of Service</Link> and <Link href="/privacy-policy" target="_blank" rel="noopener noreferrer">Privacy Policy</Link>.
                </p>
            </div>
        </div>
    );
